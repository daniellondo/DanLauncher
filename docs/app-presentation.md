...
On `feature/native-launcher-v2`, pull and run the `DanLauncher` app scheme on the iPhone. Do not recreate targets, change signing, or delete the app for this update. Edit the existing widget:
...
Backup of the previously working branch: `backup/launcher-before-app-labels-2026-09-21`, commit `ff432c528273bb13795dd63fda7845bab4eacdef`. This patch is reconciled on top of the newer native-image commit `40446098f31b1ce2ac82894fea3649c5a9f17c36`, not over the older branch tip. No changes to `.pbxproj` are required; the existing file-system-synchronized WidgetLauncher folder includes the new helper files.
